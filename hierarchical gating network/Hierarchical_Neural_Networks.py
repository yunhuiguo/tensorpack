...
class  Network(object):
    ...
    """
    def __init__(self, name, hidden_layers, activation_fn=tf.nn.relu, initializer=tf.contrib.layers.xavier_initializer, l2_regularizer = 0.01, keep_prob = 0.5):
        """
            Initilize network
...
class LocalSensorNetwork(Network):
    ...
    def __init__(self, name, x, hidden_layers, activation_fn = tf.nn.relu, initializer=tf.contrib.layers.xavier_initializer, l2_regularizer = 0.01, keep_prob = 1.0):
        """
            Initilize network
            ...
            Returns:
        """
        super(LocalSensorNetwork, self).__init__(name, hidden_layers, activation_fn, initializer,  l2_regularizer, keep_prob)
...
class CloudNetwork(Network):
    ...
    def __init__(self, name, hidden_layers, activation_fn=tf.nn.relu, initializer=tf.contrib.layers.xavier_initializer, l2_regularizer = 0.01, keep_prob = 0.5):
        super(CloudNetwork, self).__init__(name, hidden_layers, activation_fn, initializer,  l2_regularizer, keep_prob)
