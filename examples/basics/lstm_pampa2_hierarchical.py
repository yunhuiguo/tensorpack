...
def main(subject, train_data, one_hot_train_labels, \
    ...
    heart = LSTM_Network('sensor1', x[:,0], n_steps, n_hidden, output_num, 1)
    ...
    model = cloud.connect([heart,hand, chest, ankle])
    ...
    with tf.Session() as sess:
        ...
        f = open("./summary_fully_lstm.txt", "a+")
        if subject == 6:
